...
def _random_text(length=1, words=lexicon):
    return ''.join(random.sample(words, length))

# from center loss export
EDGE_WORD = ['簪', '.', '/', '铛', '粮', '4', '5', '奴', '7', '铺', '锄', '妈', '错', '锡', 'E', 'G', '柬', 'J', '妹', '柱', '级', '姥', '姨', '姬', '纱', '娄', '娇', '娘', '婷', '阵', '陇', '存', '梆', '丞', '梶', '棠', '隼', '椅', '宛', '楠', '缭', '榜', '雩', '乘', '署', '霖', '宿', '翰', '步', '歪', '耆', '韩', '颂', '毛', '仇', '飘', '仕', '尧', '付', '仙', '尸', '尽', '以', '胚', '胭', '仰', '脏', '汽', '脸', '驱', '驹', '伐', '膨', '岻', '臣', '崩', '臭', '髦', '鬓', '舟', '位', '洒', '鲱', '芊', '帐', '洲', '帷', '鸥', '侦', '麟', '俩', '倍', '默', '鼬', '茏', '茗', '座', '廖', '僧', '，', '充', '兆', '溜', '滚', '兮', '弯', '滩', '莽', '潇', '菫', '彰', '萄', '萍', '萸', '冥', '灼', '冲', '葡', '炎', '炫', '冽', '葱', '蒸', '蓉', '凛', '烤', '蔓', '凶', '击', '蔽', '蕊', '蕴', '刑', '恍', '则', '恭', '爵', '虑', '恳', '爸', '蚀', '办', '犹', '螃', '愉', '衍', '狡', '势', '补', '勋', '慢', '袈', '猜', '裁', '玖', '戚', '玥', '玦', '玩', '卉', '觉', '扉', '协', '詹', '珏', '扭', '扳', '扶', '琅', '讥', '讯', '讶', '折', '讽', '设', '访', '诈', '双', '瑾', '璋', '璐', '诘', '拼', '拽', '瓷', '诡', '持', '说', '叩', '诸', '换', '掇', '畅', '叽', '谱', '掣', '豁', '豫', '后', '吏', '搬', '搭', '摊', '贞', '皇', '盆', '摹', '撞', '购', '呜', '赏', '赠', '咔', '咕', '咚', '赶', '敦', '瞩', '距', '矩', '短', '斑', '售', '码', '砚', '喀', '载', '辅', '喷', '辑', '辖', '辞', '辨', '噩', '祝', '迁', '迎', '晚', '稳', '途', '暖', '速', '逢', '逻', '垂', '曜', '曦', '遢', '替', '埠', '竖', '站', '邋', '堡', '竺', '墙', '笛', '札', '酱', '朴', '酷', '夙', '材', '简', '杞', '杵', '篷']
def _edge_text(length=1):
    return _random_text(length, EDGE_WORD)

random_funcs += [
    # random chinese
    lambda : _random_text(1),
    lambda : _random_text(2),
    lambda : _random_text(3),
    lambda : _random_text(4),
    lambda : _random_text(5),
    lambda : _random_text(6),
    lambda : _random_text(7),
    lambda : _random_text(8),
...
random_weights += [8400, 39030, 29340, 20790, 12660, 4770, 6150, 2460,
                   8400, 39030, 29340] # sample from genshin data
